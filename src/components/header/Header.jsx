    ...
    return (
        <nav className="flex justify-between items-center py-5 px-5 md:px-16 lg:px-60 top-0 z-10 sticky backdrop-blur-xl">
            ...
            <div className="flex justify-between items-center gap-x-5 md:gap-x-12">
                ...
                <div>
                    <button className="cursor-default border border-gray-200 bg-white rounded-xl px-5 py-4 text-sm md:text-lg font-semibold flex items-center gap-x-2"><span>{coins}</span>Coins<span><img className="w-5 h-5" src="https://i.ibb.co.com/h9TXFLF/dollar.png" alt="" /></span></button>
                </div>
